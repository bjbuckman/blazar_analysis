...
directory_cor = './autocor_err/autocor_err_opt_'
# directory_sig = './autocor_sig/autocor_sig_opt_'
...
## Output
output_filename = 'object'+str(obj_num).zfill(4)+'_auto_opt_stats'+str(iout).zfill(3)+'.dat'
