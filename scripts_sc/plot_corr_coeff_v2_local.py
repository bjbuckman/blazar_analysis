...
filename_err = '../../output/cross_corr/object'+str(obj_num).zfill(4)+'_stats'+str(file_num).zfill(3)+'.dat'
filename_sig = '../../output/cross_object_gam+opt/cross_object'+str(obj_num).zfill(4)+'_all_stats_'+str(file_num).zfill(3)+'.dat'
...
ax.set_xlabel(r'Optical Lag [days]')
