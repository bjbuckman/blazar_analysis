...
if flare_num > 0:
	...
	flux_err = np.delete(flux_err, bins_remove)
...
CORRELATION[1] = correlation - CORRELATION_NO_FLARE

filename = './cor_err-opt_flare/cor_err-opt_flare'+str(flare_num).zfill(4)+'_'
