...
filename_err = '../../output/auto_opt/object'+str(obj_num).zfill(4)+'_auto_opt_stats'+str(file_num).zfill(3)+'.dat'
filename_sig = '../../output/autocorr_opt+opt/cross_stats_opt+opt_object'+str(obj_num).zfill(4)+'_'+str(file_num).zfill(3)+'.dat'
...
ax.set_ylabel('Optical Auto-Corr Coeff')


plt.tight_layout()
plot_name = './plot_ac_opt_object'+str(obj_num).zfill(4)+'_stats'+str(file_num).zfill(3)+'_'
