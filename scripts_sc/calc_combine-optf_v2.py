...
for ii in range(0,num_flares):
	filename = './cor_err-opt_flare/cor_err-opt_flare'+str(flare_num[ii]).zfill(4)+'_'+str(out_num).zfill(3)+'.dat'
...
## Output
output_filename = 'object'+str(obj_num).zfill(4)+'-opt_flare'+str(iout).zfill(3)+'.dat'
