...
l_vela = c_vela.dec.value #galactic.l.degree
if l_vela > 180:
	l_vela-=360
b_vela = c_vela.ra.value #galactic.b.degree
...
for ii in range(0,len(rng)):
	...
	l_sun[ii] = c_sun.ra.value
	if l_sun[ii] > 180:
		l_sun[ii]-=360
	b_sun[ii] = c_sun.dec.value
...
for ii in range(0,len(object_arr)):
	...
	ax0.scatter(ra,dec, alpha=excess, color=COLOR, marker=MARKER, zorder=ZORDER)
